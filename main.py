...
import threading
import time
from ansio import application_keypad, mouse_input, ansi_input
...
def initialize():
    ...
    chat_llm = models.get_ollama_chat(model_name="llama3-groq-tool-use:latest", temperature=0)
    ...
    utility_llm = chat_llm  # models.get_ollama_chat(model_name="rolandroland/llama3.1-uncensored:latest") # change if you want to use a different utility model

    # embedding model used for memory
    # embedding_llm = models.get_openai_embedding(model_name="text-embedding-3-small")
    embedding_llm = models.get_ollama_embedding(model_name="nomic-embed-text:latest")
...
def capture_keys():
        ...
        while True:
            ...
            if Agent.streaming_agent:
                ...
                with input_lock, ansi_input, application_keypad:
